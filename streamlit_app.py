...
# User Input Fields
mean = st.number_input("Mean Value", min_value=-1000.0, format="%.6f")
...
skewness = st.number_input("Skewness", min_value=-10.0, format="%.6f")
kurtosis = st.number_input("Kurtosis", min_value=-10.0, format="%.6f")
entropy = st.number_input("Entropy", min_value=0.0, format="%.6f")
fft_mean = st.number_input("FFT Mean", min_value=0.0, format="%.6f")
